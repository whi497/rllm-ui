...
- **Episode & Trajectory Inspection** — Browse/search episodes, inspect agent trajectories step-by-step (observations, actions, rewards)
...
- **Observability AI Agent** — Query your training data using natural language (experimental)
- **Project Organization** — Group runs into projects, custom session colors, automatic crash detection via heartbeats
